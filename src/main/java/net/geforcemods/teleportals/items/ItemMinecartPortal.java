package net.geforcemods.teleportals.items;
...
public class ItemMinecartPortal extends Item
{
    private static final IBehaviorDispenseItem dispenserMinecartBehavior = new BehaviorDefaultDispenseItem()
    {
        ...
        public ItemStack dispenseStack(IBlockSource par1IBlockSource, ItemStack par2ItemStack)
        {
            ...
            EntityMinecart entityminecart = EntityMinecartPortal.createMinecart(world, d0, d1 + d3, d2, ((ItemMinecartPortal)par2ItemStack.getItem()).minecartType);
    ...
    public ItemMinecartPortal(int par1)
    {
        this.maxStackSize = 1;
        this.minecartType = par1;
    ...
    {
        if (BlockRailBase.isRailBlock(par3World.getBlock(par4, par5, par6)))
        {
            if (!par3World.isRemote)
            {
                EntityMinecart entityminecart = EntityMinecartPortal.createMinecart(par3World, (double)((float)par4 + 0.5F), (double)((float)par5 + 0.5F), (double)((float)par6 + 0.5F), this.minecartType);
